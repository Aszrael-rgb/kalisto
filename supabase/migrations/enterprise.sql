...
drop policy if exists "administrators manage settings" on public.system_settings;
...
drop policy if exists "administrators read audit" on public.system_audit_logs;
...
drop policy if exists "crm lead department access" on public.crm_leads;
...
drop policy if exists "crm quote department access" on public.crm_quotes;
...
drop policy if exists "crm interaction department access" on public.crm_interactions;
...
drop policy if exists "inventory supplier access" on public.inv_suppliers;
...
drop policy if exists "inventory product access" on public.inv_products;
...
drop policy if exists "inventory movement access" on public.inv_movements;
...
drop policy if exists "finance transaction access" on public.fin_transactions;
...
drop policy if exists "finance invoice access" on public.fin_invoices;
...
drop policy if exists "employee data self or management" on public.hr_employees_data;
...
drop policy if exists "operations milestone access" on public.ops_milestones;
...
drop policy if exists "marketing department access" on public.mkt_campaigns;
...
drop policy if exists "marketing performance access" on public.mkt_performance;
